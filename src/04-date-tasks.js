...
function timeSpanToString(startDate, endDate) {
  ...
  diff -= seconds * 1000;
  return `${hours.toString(10).padStart(2, 0)}:${mins.toString(10).padStart(2, 0)}:${seconds.toString(10).padStart(2, 0)}.${diff.toString(10).padStart(3, 0)}`;
}
...
function angleBetweenClockHands(date) {
  ...
  let result = Math.abs(hours - minutes);
